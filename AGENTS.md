...
| `initialize` | COM / Studio bootstrap | `studio()` |
...
| `superprocess` | Multi-command workflows | `batch_append()`, `transform_model()`, `dxf_to_dm()`, `display_ellipsoids()` |
...
| `batch_append`, `transform_model` | `superprocess` |
