...
To access this command:
  ...
  * Using the **[command line](<Command_Toolbar.md>)** , enter "create-ramp-string"

  * Use the quick key combination "crs".

  * Display the **[Find Command](<findcommand.md>)** screen, locate **create-ramp-string** and click **Run**.

Draws a ramp string using a start point (selected interactively in a 3D window) and defined start azimuth, gradient, radius and other parameters.
...
Related topics and activities
  ...
  * [create-ramp-string](<../command_help/create-ramp-string.md>) (command)