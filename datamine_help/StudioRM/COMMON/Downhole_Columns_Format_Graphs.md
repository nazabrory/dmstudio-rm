# Downhole Formatting: Graph, Histogram
...
Graph formatting is useful for representing any numeric data attribute, such as metal grades.
...
To configure graphs on downhole columns:
