...
The first example is a run of ESTIMA using the [Nearest Neighbor](<Grade%20Estimation%20Nearest%20Neighbour.md>) and [Inverse Power Distance](<Grade%20Estimation%20Inverse%20Power%20of%20Distance.md>) methods.
...
![](../Images/NextExercise.gif)[Go to the next topic](<Grade%20Estimation%20Sichels%20T%20Estimator.md>) (Parameter summary)