# Block Model Properties: Labels

To access this screen:

  * Display the [Block Model Properties](<BlockModels_Properties_Dialog.md>) screen and select the Labels tab.

Note: A Datamine [eLearning course](<https://datamine.learnupon.com/>) is available that covers functions described in this topic. Contact your local Datamine office for more details. |   
---|---  
  
Control the formatting of the labels for block models in the active 3D window.
