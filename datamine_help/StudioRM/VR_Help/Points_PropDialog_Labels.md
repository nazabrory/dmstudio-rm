...
To access this dialog:
  ...
  * Display the [Points Properties](<points%20properties%20dialog.md>) screen and select the Labels tab.

Control the formatting of labels for points in the active 3D window, for the target overlay.
