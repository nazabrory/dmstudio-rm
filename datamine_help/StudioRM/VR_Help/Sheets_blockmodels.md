...
Note: Double-clicking the Block Models folder displays the [Data Import](<../COMMON/data%20import%20dialog.md>) screen, allowing you to select a file for import using one of the data source drivers provided.
...
Related topics and activities
  ...
  * [ Block Model Section Control](<SectionControl_Dialog.md>)