...
Wireframe surfaces and volumes are often a key part of a 3D scene. There are many formatting options available. 

The **Sheets** and **Project Data** control bars contain (product-permitting) a range of menu options, some of which are specific to wireframe data overlays.

## Wireframes Folder Menu

To access this menu:

  * Right-click the **Wireframes** folder in the **Sheets** or **Project Data** control bar (if your product has one, and is configured to use default menus).

Note: Double-clicking the Wireframes folder displays the [Data Import](<../COMMON/data%20import%20dialog.md>) screen, allowing you to select a file for import using one of the data source drivers provided.
...
Verify |  Run an integrity check on the target overlay's data object. This can help to spot wireframe formation errors. See [wireframe-verify ("wvf")](<../command_help/wireframe-verify.md>).  
---|---  
Quick Legend or  
...
Related topics and activities
  ...
  * [Wireframe Properties](<Wireframe_Properties_Dialog.md>)

  * [Draping images](<Surfaces_Draping%20images.md>)

  * [Rendering a Wireframe](<Formatting_Wireframes.md>)