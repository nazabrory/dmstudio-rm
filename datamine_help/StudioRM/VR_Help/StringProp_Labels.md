# Strings Properties: Labels

To access this screen:

  * Display the [Strings Properties](<String_Properties_Dialog_General.md>) screen and select the Labels tab.

Control the formatting of the labels for strings in the active 3D window. 
