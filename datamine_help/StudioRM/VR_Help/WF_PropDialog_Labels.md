# Wireframe Properties: Labels

To access this screen:

  * Display the [Wireframe Properties](<Wireframe_Properties_Dialog.md>) screen and select the Labels tab.

Control the formatting of the labels for wireframes for the target overlay.
