# circle-from-center-to-edge ("cec")

See this command in the [**command table**.](<_COMMAND%20TABLE_C.md#circle-from-center-to-edge>)

To access this command:

  * **Digitize** ribbon **> > Create >> Arc >> Circle by Center and Edge**.

  * Using the **[command line](<../COMMON/Command_Toolbar.md>)** , enter "circle-from-center-to-edge"

  * Use the quick key combination "cec".

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **circle-from-center-to-edge** and click **Run**.

## Command Overview

Draw a circle with a center point and a radius defined interactively in a **3D** window.
...
Command steps:
  ...
  5. Click or tap to define the center point of the circle.

  6. Click or tap to define an edge point for the circle.

  7. If required, click or click-and-drag to move the previously placed edge point.
