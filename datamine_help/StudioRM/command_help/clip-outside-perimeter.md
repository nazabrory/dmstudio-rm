# clip-outside-perimeter ("cop")

See this command in the [**command table**.](<_COMMAND%20TABLE_C.md#clip-outside-perimeter>)

To access this command:

  * **Digitize** ribbon **> > Tools >> Clip Strings >> Clip Inside Perimeter**.

  * Using the **[command line](<../COMMON/Command_Toolbar.md>)** , enter "clip-outside-perimeter".

  * Use the quick key combination "cop".

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **clip-outside-perimeter** and click **Run**.
...
![](../Images/ClipOutsidePerimeter1.gif)

After clipping:

![](../Images/ClipOutsidePerimeter2.gif)
...
All string data insidethe perimeter is removed.
