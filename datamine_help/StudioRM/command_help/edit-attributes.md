...
See this command in the [command table](<COMMAND%20TABLE_E.md#edit-attributes>).

To access this command:

  * Edit ribbon **> > Attributes >> Edit**

  * **Digitize** ribbon **> > Attributes >> Add**.

  * **Data** ribbon **> > Attributes >> Edit**.

  * Enter "edit-attributes" into the **Command** toolbar and press <ENTER>

  * Use the quick key combination "eat" with a 3D window active.

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **edit-attributes** and click **Run**.

## Command Overview

Change attribute values of strings, points, ellipsoids, planes and wireframes. Data can either be selected before or after running the command. Separate (but similar) dialogs are used to edit the attributes of [drillholes](<edit-dh-attributes.md>) and [block models](<edit-model-cell-values.md>).
...
Related Topics and Activities
  ...
  * [edit-wireframe-attributes (command)](<edit-wireframe-attributes.md>)
