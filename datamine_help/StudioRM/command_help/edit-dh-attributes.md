# edit-dh-attributes ("ed")

See this command in the [command table](<COMMAND%20TABLE_E.md#edit-dh-attributes>).
...
To access this command:
  ...
  * Use the quick key combination "ed" with a 3D window active.

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **edit-dh-attributes** and click **Run**.

## Command Overview

Change attribute values of drillholes. Data can either be selected before or after running the command. Separate (but similar) dialogs are used to edit the attributes of **[points, strings, planes, ellipsoids and wireframes](<edit-attributes.md>)** , and [block models](<edit-model-cell-values.md>).
