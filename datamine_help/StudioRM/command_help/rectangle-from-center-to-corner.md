# rectangle-from-center-to-corner ("rcec")

See this command in the [**command table**.](<COMMAND%20TABLE_R.md#rectangle-from-center-to-corner>)

To access this command:

  * **Digitize** ribbon **> > Create >> Rectangle >> Center and Corner**.

  * Using the **[command line](<../COMMON/Command_Toolbar.md>)** , enter "rectangle-from-center-to-corner"

  * Use the quick key combination "rcec".

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **rectangle-from-center-to-corner** and click **Run**.

## Command Overview

Draws a rectangle with a centre point and a corner point. Points can be digitized into any 3D window.
...
Command steps:
  ...
  4. Click to define the centre point of the rectangle.

  5. Click to define a corner point of the rectangle.
