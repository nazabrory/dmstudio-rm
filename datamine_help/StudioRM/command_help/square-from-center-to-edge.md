...
See this command in the [**command table**.](<COMMAND%20TABLE_S.md#square-from-center-to-edge>)

To access this command:

  * **Digitize** ribbon **> > Create >> Rectangle >> Square by Center and Edge**.

  * Using the **[command line](<../COMMON/Command_Toolbar.md>)** , enter "square-from-center-to-edge"

  * Use the quick key combination "sce".

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **square-from-center-to-edge** and click **Run**.
...
Command steps:
  ...
  4. Click to define the a centre point of the square.

  5. Click to define a point on the furthermost edge of the square, to define its width and height.
