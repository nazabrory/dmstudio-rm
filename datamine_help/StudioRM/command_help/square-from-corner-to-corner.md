# square-from-corner-to-corner ("scc")

See this command in the [**command table**.](<COMMAND%20TABLE_S.md#square-from-corner-to-corner>)

To access this command:

  * **Digitize** ribbon **> > Create >> Rectangle >> Square by Corners**.

  * Using the **[command line](<../COMMON/Command_Toolbar.md>)** , enter "square-from-corner-to-corner"

  * Use the quick key combination "scc".

  * Display the **[Find Command](<../COMMON/findcommand.md>)** screen, locate **square-from-corner-to-corner** and click **Run**.

## Command Overview

Draws a square by defining opposite corners. Points can be digitized into any 3D window.
...
Command steps:
  ...
  4. Click to define a corner of the square.

  5. Click to define the opposite corner of the square..
