![](../HeaderCell.jpg) |  Grade Estimation - Additional Features More details on other grade estimation functions  
---|---  
...
More Grade Estimation functions:
...
If IMETHOD=101, then the value written to the VALUE_OU field in the Output Model is the geostatistical F value i.e. the average value of the variogram in the cell. If IMETHOD=102, then the value is the Lagrange multiplier calculated when solving the Ordinary Kriging matrix.
...
Grade Estimation References](<Grade%20Estimation%20References.md>)[  
  
ESTIMA command Help   
ESTIMATE command Help  
The Estimate dialog  
VARFIT Command Help](<Grade%20Estimation%20Additional%20Features.md>)