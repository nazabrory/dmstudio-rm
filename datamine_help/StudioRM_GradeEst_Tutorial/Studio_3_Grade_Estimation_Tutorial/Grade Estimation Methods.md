![](../HeaderCell.jpg) |  Grade Estimation Methods An overview of the methods available  
---|---  
...
It is possible to select different grades to estimate, using different methods and different parameters all in a single run of ESTIMA. The different combinations of grades/methods/parameters etc. are each defined by a record in the Estimation Parameter file (&ESTPARM).
...
![](../Images/NextExercise.gif)[Proceed to the next section](<Grade%20Estimation%20Nearest%20Neighbour.md>) (Nearest Neighbour Method)
